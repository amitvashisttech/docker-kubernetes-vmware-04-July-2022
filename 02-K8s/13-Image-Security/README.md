# Note Point : In Case you are getting imagepull error stating that you have reached to max limit of downloads or you want to downlaod an image from private repo, then apply the following solution. 
